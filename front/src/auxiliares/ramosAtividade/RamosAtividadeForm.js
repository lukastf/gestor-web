...
import RamoAtividade from './RamosAtividade';
import enviarFormBase from '../../listaBase/enviarFormBase';

const RamoAtividadeForm = (props) => {
    ...
    const voltar = () => {
        ...
        props.setRoute(<RamoAtividade props={props}/>);
    }
    ...
    const enviarForm = (e) => {
        ...
        enviarFormBase(props, "ramosAtividade", setEnviarResultado);
    }
        ...
        <div className="container-fluid p-4 col-12 col-md-4">
            ...
            <form>
                <div className="form-group">
                    <label htmlFor="nome">Nome do Ramo de Atividade</label>
                    <input 
                        type="text" 
...
export default RamoAtividadeForm;