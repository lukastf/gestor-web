...
class Banco {
    ...
    constructor(props, params) {
        ...
        this.banco._id = props._id;
        this.banco.nome = props.nome;
        this.banco.idOrg = props.idOrg;

        this.banco.dataAtualizacao = new Date();
    ...
    async post () {
        ...
        this.banco.dataCadastro = new Date();

        const checkUsuarioAdmin = await Usuario.checkUsuarioAdmin(this.params);

        if (checkUsuarioAdmin) return dm.postOne(collection, this.banco);
        else return null;
    }
    ...
    async put () {
        ...
        if (checkUsuarioAdmin) return dm.putOne(collection, this.banco);
        else return null;
    }
    ...
    async delete () {
        ...
        if(checkUsuarioAdmin) return dm.deleteOne(collection, this.banco);
        else return null;
    }
}
