...
class Fornecedor {
    ...
    async post () {
        ...
        try {
            ...
            this.fornecedor.telefone = A(14, this.fornecedor.telefone);
            this.fornecedor.celular = A(14, this.fornecedor.celular);
            ...
            if (this.fornecedor.agenda[0].tipoOperacao != "") {
                ...
                for (let i = 0; i < this.fornecedor.agenda.length; i++) {
                    ...
                    this.fornecedor.agenda[i].dataInicio = D(this.fornecedor.agenda[i].dataInicio);
                    this.fornecedor.agenda[i].dataFim = D(this.fornecedor.agenda[i].dataFim);
            ...
            if (this.fornecedor.numeroLogico[0].numeroLogico != "") {
                ...
                for (let i = 0; i < this.fornecedor.numeroLogico.length; i++) {
                    ...
                    this.fornecedor.numeroLogico[i].numeroLogico = A(15, this.fornecedor.numeroLogico[i].numeroLogico);
            ...
            if (this.fornecedor.endereco[0].cep != "") {
                ...
                for (let i = 0; i < this.fornecedor.endereco.length; i++) {
                    ...
                    this.fornecedor.endereco[i].telefone = A(14, this.fornecedor.endereco[i].telefone);
                    ...
                    this.fornecedor.endereco[i].estado + "\n";
                }
            }
            ...
            fs.writeFile(arquivo, str, function (err) {
                ...
                c.on('ready', function() {
                    c.put(arquivo, '/INCLUSAO/'+ nomeArquivo +'.REM', function(err) {
                    //if (err) throw err;
                        c.end();
                    });
                });
            ...
            if(checkUsuario) return dm.postOne(collection, this.fornecedor);
            else return null;
